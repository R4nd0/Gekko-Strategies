/*
	Added a STOP-LOSS strategy to this candlebatcher strategy.
	by R4nD00m Dec'18
...
var strat = {
  ...
  check: function(candle) {
	...
	// CHECK STOPP LOSS GAIN CONDITIONS AND SHORT IF MET
	if (this.stoplow != 0 && this.candle.close < this.stoplow) this.advice('short');
	if (this.stophigh != 0 && this.candle.close > this.stophigh) this.advice('short');
  ...
  short: function() {
    ...
    //if (this.trend.direction !== 'down'|| this.stoplow != 0 && this.candle.close < this.stoplow || this.stophigh != 0 && this.candle.close > this.stophigh) {
	//if (this.trend.direction !== 'down' &&  this.candle.close > this.lastLongPrice+(this.lastLongPrice * this.Min_Gain_Percent / 100) && this.candle.close < this.lastLongPrice-(this.lastLongPrice * this.Min_Loss_Percent / 100) || this.stoplow != 0 && this.candle.close < this.stoplow || this.stophigh != 0 && this.candle.close > this.stophigh) {
    if (this.trend.direction !== 'down' || this.stoplow != 0 && this.candle.close < this.stoplow || this.stophigh != 0 && this.candle.close > this.stophigh) { 
		if (this.trend.direction !== 'down' && (this.candle.close > this.lastLongPrice+(this.lastLongPrice * this.Min_Gain_Percent / 100) || this.candle.close < this.lastLongPrice-(this.lastLongPrice * this.Min_Loss_Percent / 100)))
		{ 
		  this.resetTrend();
